...
public class HttpsServers {
	  //这个例子会展示如何配置SSL，我们需要一个秘钥库，会在jetty.home下面找
	 public static void main(String[] args) throws Exception {
//		 String jettyDistKeystore = "E:/github/jetty-distribution-9.4.9.v20180320/demo-base/etc/keystore";
		 String jettyDistKeystore = "F:/keystore";
	    String keystorePath = System.getProperty("example.keystore", jettyDistKeystore);
	    System.out.print("keystorePath"+keystorePath);
